...
export const translations = {
  "zh-Hant": {
    ...
    homeTitle: "探索台灣上市櫃公司。",
    homeDescription:
      "此首頁直接讀取 repo 建出的 API，聚焦公開瀏覽情境：ticker 查詢、產業篩選，以及供應鏈研究入口。",
    snapshot: "快照",
    apiStatus: "API 狀態",
    companies: "公司數",
    topSector: "主要產業",
  ...
  en: {
    ...
    homeDescription:
      "This frontend reads from the repo-built API layer and focuses on public browsing: ticker lookup, sector filtering, and direct access to enriched supply chain coverage.",
    snapshot: "Snapshot",
